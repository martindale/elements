...
enum
{
    ...
    SCRIPT_VERIFY_INCREASE_CONFIRMATIONS_REQUIRED = (1U << 14)
};
...
public:
    TransactionNoWithdrawsSignatureChecker(const CTransaction* txToIn, unsigned int nInIn, const CTxOutValue& amountIn) : txTo(txToIn), nIn(nInIn), amount(amountIn) {}
