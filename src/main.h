...
public:
    CScriptCheck(const CCoins& txFromIn, const CTransaction& txToIn, unsigned int nInIn, const CTxOutValue& amountPreviousInputIn, CAmount nTxFeeIn, int nSpendHeightIn, unsigned int nFlagsIn, bool cacheIn, PrecomputedTransactionData* txdataIn) :
        scriptPubKey(txFromIn.vout[txToIn.vin[nInIn].prevout.n].scriptPubKey), amount(txFromIn.vout[txToIn.vin[nInIn].prevout.n].nValue),
        amountPreviousInput(amountPreviousInputIn),
        ptxTo(&txToIn), nIn(nInIn), nTxFee(nTxFeeIn), nSpendHeight(nSpendHeightIn), nFlags(nFlagsIn), cacheStore(cacheIn), txdata(txdataIn) { }
